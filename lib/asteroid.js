(function () {
  ...
  Asteroid.prototype.registerCollision = function (bullet, response) {
    ...
    // else if (Asteroids.Util.distance(
    //   this.newVertices[this.newVertexIdxs[1]], bullet.pos) < Asteroids.Util.distance(
    //   this.newVertices[this.newVertexIdxs[0]], bullet.pos)) {
    //   // the bullet entered at the former
    //   debugger
    //   this.newVertexIdxs[1]++;
    // }  else if (this.newVertexIdxs[1] - this.newVertexIdxs[0] === 1) {
    //   this.newVertexIdxs[1]++;
    // }
  }
